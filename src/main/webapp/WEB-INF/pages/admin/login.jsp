...
<html>
  <head>
	...
	<link rel="stylesheet" href="${path}/resources/admin/css/layui.css">
  ...
  <body class="login-bg">
    <div class="login-box">
        ...
        <div class="login-main">
			<form action="/moment/admin/dologin.action" class="layui-form" method="post">
    ...
    <script src="${path}/resources/admin/js/layui.js"></script>
    <script>
